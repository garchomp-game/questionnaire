...
仕事場では、常にコミュニケーションの連続ですので、機会を見つけたら積極的に自ら報連相や確認を撮ることを先ずいし気づける必要があると感じています。

日々の生活の中でも、マストでコミュニケーションを取らないといけないことは積極的に撮るように意識し、経験を重ねることで上達していくもの。と考えています。

### 仕事は特に、趣味開発もできるだけメモや資料作成を心がける

メモをよく取る人は、普段プライベートでもちゃんとメモとっていることがわかりました。

仕事だからメモを取る。という意識では結局タイミング逃してしまったり体が覚えていないので忘れてしまうと思います。なのでまずはメモを取る癖を付けるために、日常からポケットに常にメモ帳とペンを入れて何かあったらメモをとることを習慣づけて郁人が必要かなと考えています。

また、自分は手書きがかなり苦手で、そのためメモを摂る行為を避けてきたところがあると思うので、きれいな字で書くのは後回しで、まずはメモを摂る。という意識も同時にしていくべきだと考えています。

練習試合から真面目に取り組まないといざ本番の時も上手くいくわけがない。という理論と同じです。

### 現場にある完成物をみたりベテランから設計のやり方を積極的に学ぶことを心がける

会社にドキュメントがあるなら、まずはひたすら読み漁ってみる。隅々まで目を通してみる。

その中で疑問点があればとりあえずまずは殴り書きでもいいのでメモをとり、時間があれば自分の中で要件をマークダウンに整理していく。その中で自分が担当する箇所予めわかっているなら関係性を図に起こして全体を見える化する。ということをまずは意識していこうと思います。
